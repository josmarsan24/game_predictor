...
a2,b2,c2,d2 = test_no_fg_no_3p(test_games)

print("GAMES PREDICTED: ", a+b)

print("DEFAULT PREDICT")
...
print("IGNORING FG AND 3P")
print("SUCCESS RATE: ", 100*a2/(a2+b2),"%")
print("RIGHT PREDICTIONS: ", a2)
print("WRONG PREDICTIONS: ", b2)
print(" OF WHICH:")
print(" MISTAKES IN ACCEPTABLE MARGAIN: ", d2)
print(" MISTAKES IN DECENT MARGAIN: ", b2 - (c2 + d2))
print(" MISTAKES IN UNACCEPTABLE MARGAIN: ", d2)